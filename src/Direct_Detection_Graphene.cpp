...
// 	double prefactor = 0.5 / pow(2.0 * M_PI, 4) * DM_distr.DM_density / mDM *graphene.N_cell * sqrt(2.0 * pow(mElectron * E_e, 3.0)) * sigma_e / mu_e / mu_e;
...
// 	double sigma_e	 = DM.Sigma_Electron();
// 	double mu_e		 = libphysica::Reduced_Mass(mElectron, mDM);
// 	double prefactor = std::sqrt(2.0 * std::pow(mElectron * E_e, 3.0)) / pow(2.0 * M_PI, 4) * DM_distr.DM_density / mDM *graphene.N_cell * sigma_e / mu_e / mu_e;
